...
function LogicSimApp() {
    ...
    this.initialize = function (canvas) {
        ...
        popup.add('Hide Label', function (gate) {
            gate.displayLabel = LabelDisplay.none;
        }, menu);
        popup.add('On Left', function (gate) {
            gate.displayLabel = LabelDisplay.left;
        }, menu);
        popup.add('On Top', function (gate) {
            gate.displayLabel = LabelDisplay.top;
        }, menu);
        popup.add('On Right', function (gate) {
            gate.displayLabel = LabelDisplay.right;
        }, menu);
        popup.add('On Bottom', function (gate) {
            gate.displayLabel = LabelDisplay.bottom;
        }, menu);
